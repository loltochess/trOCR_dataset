...
labels_file_list = ["labels_valid_background.txt", "labels_valid_basic.txt", "labels_valid_blur_1.txt", "labels_valid_blur_2.txt"]

# 원본 레이블 파일 경로
# labels_file_path = "labels.txt"

image_folder_list = ["valid_background","valid_basic","valid_blur_1","valid_blur_2e"]
...
new_files_list = ["labels_valid_background_renamed.txt", "labels_valid_basic_renamed.txt", "labels_valid_blur_1_renamed.txt", "labels_valid_blur_2_renamed.txt"]
